# HostedExchangeConnectionCreationModel
## Properties
...
```powershell
$HostedExchangeConnectionCreationModel = Initialize-FLY.ClientHostedExchangeConnectionCreationModel  -Name null `
 -Description null `
 -ConnectionType null `
 -ConnectionSide null `
 -TenantId null `
...
```powershell
$HostedExchangeConnectionCreationModel | ConvertTo-JSON
```
