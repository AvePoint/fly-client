# PowerPlatformConnectionCreationModel
## Properties
...
```powershell
$PowerPlatformConnectionCreationModel = Initialize-FLY.ClientPowerPlatformConnectionCreationModel  -Name null `
 -Description null `
 -ConnectionType null `
 -ConnectionSide null `
 -TenantId null `
...
```powershell
$PowerPlatformConnectionCreationModel | ConvertTo-JSON
```
