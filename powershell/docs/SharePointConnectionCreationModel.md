# SharePointConnectionCreationModel
## Properties
...
```powershell
$SharePointConnectionCreationModel = Initialize-FLY.ClientSharePointConnectionCreationModel  -Name null `
 -Description null `
 -ConnectionType null `
 -ConnectionSide null `
 -TenantId null `
...
```powershell
$SharePointConnectionCreationModel | ConvertTo-JSON
```
