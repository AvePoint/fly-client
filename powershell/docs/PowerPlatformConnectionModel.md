...
```powershell
$PowerPlatformConnectionModel = Initialize-FLY.ClientPowerPlatformConnectionModel  -ConnectionType null `
 -ConnectionSide null `
 -TenantId null `
 -ContainerId null `
 -AppProfileId null `
...
```powershell
$PowerPlatformConnectionModel | ConvertTo-JSON
```
