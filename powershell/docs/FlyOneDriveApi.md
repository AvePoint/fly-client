...
[**Export-FlyOneDrivePolicy**](FlyOneDriveApi.md#export-flyonedrivepolicy) | Export the OneDrive migration policy to a json file.
[**Import-FlyOneDrivePolicy**](FlyOneDriveApi.md#import-flyonedrivepolicy) | Import the OneDrive migration policy from a json file.
[**New-FlyOneDrivePolicy**](FlyOneDriveApi.md#new-flyonedrivepolicy) | Create a new OneDrive migration policy.
...
<a name="export-flyonedrivepolicy"></a>
# **Export-FlyOneDrivePolicy**
> Export-FlyOneDrivePolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-PolicyName] <String><br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-OutFile] <String><br>

Export the OneDrive migration policy to a json file.
...
### Example
```powershell
$PolicyName = "OneDrivePolicyName"
$OutFile = "Export_OneDrivePolicy_JSONFile"

Export-FlyOneDrivePolicy -PolicyName $PolicyName -OutFile $OutFile
```

[[Back to top]](#) [[Back to API list]](FlyApi.md#documentation-for-cmdlets) [[Back to README]](../README.md)

<a name="import-flyonedrivepolicy"></a>
# **Import-FlyOneDrivePolicy**
> Import-FlyOneDrivePolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Path] <String><br>

Import the OneDrive migration policy from a json file.
...
### Example
```powershell
$Path = "Import_OneDrivePolicy_JSONFile"

Import-FlyOneDrivePolicy -Path $Path
```

[[Back to top]](#) [[Back to API list]](FlyApi.md#documentation-for-cmdlets) [[Back to README]](../README.md)

<a name="new-flyonedrivepolicy"></a>
# **New-FlyOneDrivePolicy**
> New-FlyOneDrivePolicy<br>
> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[-Policy] <OneDrivePolicy><br>

Create a new OneDrive migration policy.

### Parameters

Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
**Policy** | **OneDrivePolicy** | Specify the OneDrivePolicy class to create. Configure required properties before calling. | Import policy module before new policy class.
...
$policy = [OneDrivePolicy]::new('OneDrive Policy Name')
$policy.EnableDefaultDocumentsLibrary = $false
$policy.EnableAllInOneDrive = $true
...
New-FlyOneDrivePolicy -Policy $policy
```
