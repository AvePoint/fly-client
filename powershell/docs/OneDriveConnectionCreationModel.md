# OneDriveConnectionCreationModel
## Properties
...
```powershell
$OneDriveConnectionCreationModel = Initialize-FLY.ClientOneDriveConnectionCreationModel  -Name null `
 -Description null `
 -ConnectionType null `
 -ConnectionSide null `
 -TenantId null `
...
```powershell
$OneDriveConnectionCreationModel | ConvertTo-JSON
```
